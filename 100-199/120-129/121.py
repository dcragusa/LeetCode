...
"""
Our approach to this is simple: the maximum profit is the highest number we encounter after the lowest number we have
so far. So we iterate over the array, keeping track of the current minimum price and the maximum profit obtained by 
