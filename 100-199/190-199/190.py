...
"""
We first convert the given int to a binary string, then strip the '0b' prefix and left pad to 32 bits. Then we return
the integer by passing base two to int().
"""
